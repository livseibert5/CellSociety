...
public class SegregationController extends Controller {
  ...
  /**
   * method to set intial grid of segregation cell and make sure that the map is properly set as
   * well as any empty cells
   *
  ...
  private void setNewCellStateAndAddToEmptyLocations(Grid newGrid, int i, int j, int oldState,
      int newState) {
